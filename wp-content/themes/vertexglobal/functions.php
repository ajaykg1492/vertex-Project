...
function twentynineteen_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Contact', 'twentynineteen' ),
			'id'            => 'contact',
			'description'   => __( 'Add Contact here to appear in your website.', 'twentynineteen' ),
			'before_widget' => '',
	        'after_widget' 	=> '',
	        'before_title' 	=> '',
	        'after_title' 	=> '',
	...
	register_sidebar(
		array(
			...
			'id'            => 'footer',
			'description'   => __( 'Add Footer here to appear in your website.', 'twentynineteen' ),
			'before_widget' => '',
	        'after_widget' 	=> '',
	        'before_title' 	=> '',
	        'after_title' 	=> '',
